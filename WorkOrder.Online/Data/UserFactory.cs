            ...
            try
            {
                ...
                if (organizationId != 0)
                {
                    sql = @"SELECT U.Id,
                        ...
                        (SELECT ClaimValue FROM AspNetUserClaims WHERE UserId = U.Id and ClaimType = 'Cellphone') AS Cellphone,
                        (SELECT ClaimValue FROM AspNetUserClaims WHERE UserId = U.Id and ClaimType = 'HourlyRate') AS CostHour,
                        (SELECT ClaimValue FROM AspNetUserClaims WHERE UserId = U.Id and ClaimType = 'Categories') AS UserCategories,
                        U.Email,
                        U.UserName,
