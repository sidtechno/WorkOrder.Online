...
namespace WorkOrder.Online.Data
{
    public class WorkOrderFactory : IWorkOrderFactory
    {
        ...
        public WorkOrderFactory(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<IEnumerable<WorkOrderModel>> GetWorkOrders(int organizationId)
        {
            var sql = @"SELECT [Id]
                  ,[ProjectNo]
                  ,[Description]
            ...
            using (var connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                ...
                var result = await connection.QueryAsync<WorkOrderModel>(sql,
                             new
                             {
